        ...
        <div className="w-full">
            ...
            <div className="py-8 px-4 bg-background">
                <div className="max-w-4xl mx-auto flex flex-col items-center">
                    {/* Contact Card */}
                    <div className="relative w-full min-h-[500px] group overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-br from-slate-800 to-gray-900 p-8 md:p-12 flex flex-col justify-center items-center text-center text-white">
