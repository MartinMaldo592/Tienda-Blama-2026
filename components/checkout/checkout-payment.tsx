    ...
    return (
        <div className="space-y-4 pt-4 border-t">
            ...
            <RadioGroup value={value} onValueChange={onChange} disabled={disabled} className="grid grid-cols-1 gap-3">
                ...
                <div className={`relative flex items-start space-x-3 border p-4 rounded-xl cursor-pointer transition-all ${value === 'whatsapp' ? 'border-green-600 bg-green-50/50 shadow-sm ring-1 ring-green-600' : 'hover:border-gray-300'}`}>
                ...
                <div className={`relative flex items-start space-x-3 border p-4 rounded-xl cursor-pointer transition-all ${value === 'culqi' ? 'border-blue-600 bg-blue-50/50 shadow-sm ring-1 ring-blue-600' : 'hover:border-gray-300'}`}>
