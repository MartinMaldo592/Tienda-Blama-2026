...
export function LayoutShell({ children, announcementData }: LayoutShellProps) {
  ...
  return (
    <>
      ...
      {!isOpenWa && (
        <div className="fixed bottom-24 right-4 md:bottom-8 md:right-6 z-50 flex items-center justify-center group">
          ...
          <a
            ...
            className="relative inline-flex h-14 w-14 items-center justify-center rounded-full bg-green-600 text-white shadow-xl transition-all duration-300 hover:scale-110 hover:bg-green-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2"
          >
            <svg
              viewBox="0 0 32 32"
              width="28"
