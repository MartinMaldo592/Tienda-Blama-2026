...
## Corpus Check
- 317 files · ~172,441 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1499 nodes · 3315 edges · 176 communities (96 shown, 80 thin omitted)
...
- zustand
- postcss.config.mjs
- Fase 6: OptimizaciÃ³n de Cabecera, NavegaciÃ³n MÃ³vil y Carruseles Interactivos Premium (UX/UI)
- Find Skills
...
- README.md
- ðŸš€ Historial y Resumen de Mejoras TÃ©cnicas (Mayo 2026)
- Lógica de Negocio y Flujo de Operaciones
- Fase 10: CentralizaciÃ³n de AnalÃ­ticas, AtribuciÃ³n de TrÃ¡fico y OptimizaciÃ³n de Medios (Junio 2026)
- Fase 9: Sistema de SuscripciÃ³n al Newsletter con GeneraciÃ³n de Cupones Ãšnicos y No Transferibles
- Common KPIs by Department
- Fase 5: OptimizaciÃ³n del Flujo LogÃ­stico a Provincias y Control Multicourier (Shalom / Olva)
- Fase 3: Mitigación de Riesgos y Control de Fallos Operativos (AMFE)
- Informe de Mejoras e Implementaciones - Tienda Blama 2026
- Fase 8: Filtros MultiselecciÃ³n Inteligentes en GestiÃ³n de Pedidos (CRM Admin)
- Fase 4: ConsolidaciÃ³n, Mapeo y Seguridad de Base de Datos (Supabase)
...
## Communities (176 total, 80 thin omitted)

### Community 0 - "button.tsx"
Cohesion: 0.08
Nodes (72): ClientesPage(), CouponRow, CouponType, PROCESS_STATUSES, ProcessStatus, StatusFilter, Tipo, TipoFilter (+64 more)

### Community 1 - "dialog.tsx"
Cohesion: 0.18
Nodes (14): DialogContent, DialogDescription, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle, ACCENT_MAP, inputId() (+6 more)

### Community 2 - "quick-checkout-modal.tsx"
Cohesion: 0.10
Nodes (24): QuickCheckoutModal, QuickCheckoutModal, SuccessPage(), SuccessCheckmark(), QuickCheckoutModalProps, QuickForm(), QuickCustomer(), CheckoutDraft (+16 more)

### Community 3 - "createClient"
Cohesion: 0.20
Nodes (13): POST(), POST(), POST(), ALLOWED_CONTENT_TYPES, GET(), getEnv(), normalizeDigits(), normalizeText() (+5 more)
...
Cohesion: 0.12
Nodes (20): ContactoPage(), ContactSection, CartButton(), ContactSection(), AnimationItem, CartAnimationState, useCartAnimationStore, useCartStore (+12 more)

### Community 6 - "ProductosClient.tsx"
Cohesion: 0.32
Nodes (9): emptyCartAnimation, Lottie, Sheet(), SheetClose(), SheetContent(), SheetDescription(), SheetHeader(), SheetTitle() (+1 more)
...
Cohesion: 0.08
Nodes (22): geistMono, geistSans, getAnnouncementData, metadata, RootLayout(), Providers(), AnnouncementBar(), AnnouncementBarProps (+14 more)

### Community 10 - "product-form.tsx"
Cohesion: 0.05
Nodes (54): AdminAnnouncementBarPage(), normalizeMessages(), parseBoolVal(), toBoolVal(), AdminMarketingPage(), UsuariosPage(), AnnouncementBarConfig, getAnnouncementBarConfigAction() (+46 more)
...
Cohesion: 0.20
Nodes (17): AdminDashboard(), useCurrentUserId(), DashboardStockBajoPage(), SalesChart(), SalesChartProps, SalesDataPoint, useDashboardStats(), useSalesChart() (+9 more)

### Community 13 - "utils.ts"
Cohesion: 0.21
Nodes (12): ProductoDetalleClient(), ProductoDetalleClientProps, ProductImageCarousel(), ProductImageCarouselProps, ProductSocialProof(), Accordion(), AccordionContent(), AccordionItem() (+4 more)

### Community 14 - "checkout-form.tsx"
Cohesion: 0.14
Nodes (12): CheckoutAddress(), CheckoutAddressProps, CheckoutCustomer(), CheckoutCustomerProps, CheckoutFormProps, FormContent(), libraries, CheckoutShipping() (+4 more)

### Community 15 - "CuponesAdminPage"
Cohesion: 0.31
...
Cohesion: 0.12
Nodes (19): AuditPage(), DashboardVentasPage(), AdminLayout(), ForgotPasswordPage(), AdminSidebar(), AdminSidebarProps, AnnouncementBarConfig, AuditLog (+11 more)

### Community 19 - "formatCurrency"
Cohesion: 0.19
Nodes (10): CorporateDashboardProps, EzMartDashboard(), OrdersTable(), renderOriginBadge(), CheckoutSummary, CheckoutSummaryProps, QuickCheckoutModal(), QuickSummary() (+2 more)

### Community 20 - "rate-limit.ts"
Cohesion: 0.16
Nodes (17): generateCouponCode(), getEnv(), POST(), runtime, SubscribeBodySchema, POST(), NewsletterWelcomeEmail(), sendNewsletterWelcomeEmail() (+9 more)
...
### Community 26 - "marketing-pixels.tsx"
Cohesion: 0.40
Nodes (4): ATTRIBUTION_PARAMS, AttributionTracker(), ActivePixel, MarketingPixels()

### Community 27 - "checkout/index.ts"
Cohesion: 0.12
Nodes (21): CheckoutItemSchema, CulqiCheckoutSchema, getEnv(), POST(), runtime, CheckoutBodySchema, CheckoutItemSchema, GET() (+13 more)
...
### Community 29 - "create-order-modal.tsx"
Cohesion: 0.23
Nodes (10): CreateOrderModal(), CreateOrderModalProps, SelectedItem, createManualPedido(), fetchActiveProductsForOrder(), uploadProductImages(), uploadProductVideos(), compressImageInBrowser() (+2 more)
...
Cohesion: 0.15
Nodes (20): ProductosClientProps, countProducts(), CountProductsParams, getProductDetail(), getRecommendedProducts(), listCategories(), listProducts(), ListProductsParams (+12 more)

### Community 35 - "pedidos/page.tsx"
Cohesion: 0.21
Nodes (13): PedidosPageContent(), OrdersBulkActions(), OrdersFilterBar(), assignPedidoToWorker(), BulkStockError, checkBulkStockSufficient(), CreateManualPedidoArgs, fetchAdminWorkers() (+5 more)
...
Cohesion: 0.24
Nodes (14): buildDescription(), buildProductUrl(), generateMetadata(), generateStaticParams(), parseProductIdentifier(), ProductoDetallePage(), revalidate, ProductoDetalleClient() (+6 more)
...
Cohesion: 0.16
Nodes (6): CheckoutPage(), Skeleton(), DashboardStatsSkeleton(), OrderRowSkeleton(), TableRowSkeletonProps, CheckoutForm()
...
### Community 59 - "pedidos/[id]/page.tsx"
Cohesion: 0.24
Nodes (10): PedidoDetallePage(), Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger(), OrderCustomerCard(), OrderNotesCard() (+2 more)

### Community 79 - "product-card.tsx"
Cohesion: 0.23
Nodes (9): NotFound(), Home(), revalidate, sitemap(), Product, ProductCard(), ProductCardProps, getHomePageData() (+1 more)
...
### Community 97 - "Fase 6: OptimizaciÃ³n de Cabecera, NavegaciÃ³n MÃ³vil y Carruseles Interactivos Premium (UX/UI)"
Cohesion: 0.13
Nodes (15): 10. BotÃ³n de WhatsApp Flotante Adaptativo e Interactivo Premium, 11. Colapsado por Defecto del AcordeÃ³n de DescripciÃ³n del Producto, 12. RemociÃ³n Completa de DirecciÃ³n FÃ­sica (Modelo 100% Tienda Virtual), 13. Reemplazo del Icono de Compartir Producto (Estilo Tradicional), 14. ModificaciÃ³n de TÃ­tulo de Newsletter (SuscripciÃ³n), 14. ModificaciÃ³n de TÃ­tulo de Newsletter (SuscripciÃ³n), 1. Centrado Absoluto del Logotipo y Limpieza de Cabecera, 2. OptimizaciÃ³n MÃ³vil y del MenÃº Hamburguesa (+7 more)
...
### Community 108 - "ðŸš€ Historial y Resumen de Mejoras TÃ©cnicas (Mayo 2026)"
Cohesion: 0.25
Nodes (8): 1. Seguimiento DinÃ¡mico de Porcentaje (XHR Native), 1. TransiciÃ³n Seguro a `.maybeSingle()`, 2. EstÃ¡ndar Next.js 16 Edge Proxy, 2. Panel Multitarea de Progreso en Panel de AdministraciÃ³n, Fase 1: Robustez y Resiliencia en Consultas del Core (PostgREST), Fase 7: Sistema Profesional de Carga de Medios y Feedback en Tiempo Real (UX/UI Admin), ðŸ“‚ Ã�ndice de Mejoras por Fases, ðŸš€ Historial y Resumen de Mejoras TÃ©cnicas (Mayo 2026)
...
### Community 110 - "Fase 10: CentralizaciÃ³n de AnalÃ­ticas, AtribuciÃ³n de TrÃ¡fico y OptimizaciÃ³n de Medios (Junio 2026)"
Cohesion: 0.29
Nodes (7): 1. Rastreador de AtribuciÃ³n Global & Persistencia de Cookies, 2. Arquitectura de 4 PÃ­xeles Unificada (Meta & TikTok), 3. SoluciÃ³n a Alerta de TikTok (Advanced Matching en Conversiones), 4. SoluciÃ³n a Bloqueo de NavegaciÃ³n en TikTok WebViews, 5. Incremental Static Regeneration (ISR) y Carga de Scripts Diferida, 6. Almacenamiento Optimizado (Cloudflare R2 y Doble Formato de Video), Fase 10: CentralizaciÃ³n de AnalÃ­ticas, AtribuciÃ³n de TrÃ¡fico y OptimizaciÃ³n de Medios (Junio 2026)

### Community 111 - "Fase 9: Sistema de SuscripciÃ³n al Newsletter con GeneraciÃ³n de Cupones Ãšnicos y No Transferibles"
Cohesion: 0.33
Nodes (6): 1. Base de Datos & Seguridad (Supabase), 2. Plantilla de Correo de Bienvenida Premium (React-Email & Resend), 3. Endpoint de Registro & PrevenciÃ³n de Spam, 4. Componente de UI Frontend, 5. ValidaciÃ³n de Propiedad del CupÃ³n en Checkout (No Transferencia), Fase 9: Sistema de SuscripciÃ³n al Newsletter con GeneraciÃ³n de Cupones Ãšnicos y No Transferibles
...
### Community 113 - "Fase 5: OptimizaciÃ³n del Flujo LogÃ­stico a Provincias y Control Multicourier (Shalom / Olva)"
Cohesion: 0.40
Nodes (5): 1. Robustez de Base de Datos y SincronizaciÃ³n Remota (DEV & PROD), 2. Checkout Adaptativo de Alta ConversiÃ³n (Sin FricciÃ³n), 3. Ficha CRM LogÃ­stica Flexible e Interactiva, 4. Emails Transaccionales Adaptativos (Alta Fidelidad), Fase 5: OptimizaciÃ³n del Flujo LogÃ­stico a Provincias y Control Multicourier (Shalom / Olva)

### Community 114 - "Fase 3: Mitigación de Riesgos y Control de Fallos Operativos (AMFE)"
Cohesion: 0.40
Nodes (5): 1. Robustez e Idempotencia en Pasarela Culqi (Webhook), 2. SincronizaciÃ³n CRM de Panel de AdministraciÃ³n en Tiempo Real (Supabase Realtime), 3. MitigaciÃ³n del Cansancio Operativo (VerificaciÃ³n Manual Shalom), 4. MaximizaciÃ³n en Captura de Correos, Fase 3: Mitigación de Riesgos y Control de Fallos Operativos (AMFE)
...
### Community 116 - "Fase 8: Filtros MultiselecciÃ³n Inteligentes en GestiÃ³n de Pedidos (CRM Admin)"
Cohesion: 0.50
Nodes (4): 1. Desplegables Interactivos MultiselecciÃ³n, 2. Soporte en el Backend y consultas a Supabase, 3. Filtro de Estado de Pago del Pedido (`pago_status`), Fase 8: Filtros MultiselecciÃ³n Inteligentes en GestiÃ³n de Pedidos (CRM Admin)

### Community 117 - "Fase 4: ConsolidaciÃ³n, Mapeo y Seguridad de Base de Datos (Supabase)"
Cohesion: 0.50
Nodes (4): 1. Esquema Maestro Unificado y Declarativo, 2. Semilla de Prueba Optimizada, 3. Archivo del Historial y Limpieza de RaÃ­z, Fase 4: ConsolidaciÃ³n, Mapeo y Seguridad de Base de Datos (Supabase)

### Community 118 - "Fase 2: Escalabilidad, Media y Correos Transaccionales (Enterprise)"
Cohesion: 0.50
Nodes (4): 1. Rate Limiting Serverless Inteligente (Upstash Redis), 2. Pipeline de CompresiÃ³n y OptimizaciÃ³n de ImÃ¡genes (Sharp + R2), 3. Correos Transaccionales Interactivos con Validación de Shalom, Fase 2: Escalabilidad, Media y Correos Transaccionales (Enterprise)

### Community 123 - "checkout/types.ts"
Cohesion: 0.31
...
### Community 125 - "cn"
Cohesion: 0.11
Nodes (19): CardAction(), RadioGroup, RadioGroupItem, ScrollArea(), ScrollBar(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton() (+11 more)
...
### Community 128 - "incidencias.client.ts"
Cohesion: 0.43
Nodes (6): IncidenciasPage(), createIncidencia(), deleteIncidencia(), fetchIncidencias(), fetchPedidosForIncidencias(), uploadIncidenciaImages()
...
### Community 166 - "cart/types.ts"
Cohesion: 0.38
Nodes (4): CartItem, CartState, Product, ProductVariant

### Community 167 - "resenas.client.ts"
Cohesion: 0.47
Nodes (5): AdminResenasPage(), deleteReview(), fetchAdminReviews(), fetchAdminReviewsPaginated(), setReviewApproved()
...
### Community 171 - "preguntas.client.ts"
Cohesion: 0.60
Nodes (4): AdminPreguntasPage(), fetchAdminQuestions(), saveQuestionAnswer(), setQuestionPublished()

### Community 172 - "DashboardPedidosEnProcesoPage"
Cohesion: 0.33
Nodes (4): DashboardPedidosEnProcesoPage(), DashboardPedidosPendientesPage(), fetchAdminPedidosEnProceso(), fetchAdminPedidosPendientes()

### Community 174 - "ProfileRow"
Cohesion: 0.50
Nodes (4): OrdersBulkActionsProps, OrdersFilterBarProps, OrdersTableProps, ProfileRow
...
- **Why does `createClient()` connect `createClient` to `button.tsx`, `incidencias.client.ts`, `login/page.tsx`, `quick-checkout-modal.tsx`, `createClient`, `ProductosClient.tsx`, `app/layout.tsx`, `product-form.tsx`, `dashboard/page.tsx`, `CuponesAdminPage`, `admin/types.ts`, `marketing-pixels.tsx`, `create-order-modal.tsx`, `social-links.client.ts`, `products.server.ts`, `pedidos/page.tsx`, `resenas.client.ts`, `preguntas.client.ts`, `DashboardPedidosEnProcesoPage`, `PedidoRow`, `pedidos/[id]/page.tsx`, `checkout/types.ts`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Button()` connect `button.tsx` to `dialog.tsx`, `login/page.tsx`, `quick-checkout-modal.tsx`, `useProductDetail.ts`, `ProductosClient.tsx`, `product-form.tsx`, `dashboard/page.tsx`, `utils.ts`, `checkout-form.tsx`, `formatCurrency`, `create-order-modal.tsx`, `app/page.tsx`, `pedidos/page.tsx`, `order-label-generator.tsx`, `PedidoRow`, `skeleton.tsx`, `pedidos/[id]/page.tsx`, `product-card.tsx`, `cn`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `button.tsx`, `dialog.tsx`, `quick-checkout-modal.tsx`, `ProductosClient.tsx`, `utils.ts`, `checkout-form.tsx`, `skeleton.tsx`, `formatCurrency`, `pedidos/[id]/page.tsx`?**
...
- **Should `button.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.08200323849178812 - nodes in this community are weakly interconnected._
- **Should `quick-checkout-modal.tsx` be split into smaller, more focused modules?**
