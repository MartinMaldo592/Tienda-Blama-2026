...
Cohesion: 0.09
Nodes (71): ClientesPage(), CouponRow, CouponType, DashboardPedidosEnProcesoPage(), PROCESS_STATUSES, ProcessStatus, StatusFilter, DashboardPedidosPendientesPage() (+63 more)

### Community 1 - "pedidos/[id]/page.tsx"
Cohesion: 0.07
Nodes (42): OrderLabelGenerator, PedidoDetallePage(), PedidoTicketPage(), DialogContent, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle (+34 more)

### Community 2 - "quick-checkout-modal.tsx"
Cohesion: 0.12
Nodes (24): QuickCheckoutModalProps, QuickForm(), CheckoutDraft, useCheckoutDraft(), checkoutFormSchema, CheckoutFormValues, useCheckoutForm(), UseCheckoutFormOptions (+16 more)

### Community 3 - "label.tsx"
Cohesion: 0.10
Nodes (27): ForgotPasswordPage(), Label(), CategorySelector(), DEFAULT_CATEGORIES, MediaManager(), MediaManagerProps, UploadProgressInfo, ProductAttributes() (+19 more)
...
Cohesion: 0.13
Nodes (18): ContactoPage(), ContactSection, ProductoDetalleClient(), CartButton(), ContactSection(), LayoutShell(), AnimationItem, CartAnimationState (+10 more)

### Community 6 - "ProductosClient.tsx"
Cohesion: 0.24
Nodes (11): emptyCartAnimation, Lottie, CartButton, Sheet(), SheetClose(), SheetContent(), SheetDescription(), SheetHeader() (+3 more)
...
Cohesion: 0.14
Nodes (12): revalidate, sitemap(), AnnouncementBar(), AnnouncementBarProps, Footer(), SocialLink, Header(), AnnouncementData (+4 more)

### Community 10 - "products.ts"
Cohesion: 0.06
Nodes (55): AdminAnnouncementBarPage(), normalizeMessages(), parseBoolVal(), toBoolVal(), AdminMarketingPage(), UsuariosPage(), POST(), POST() (+47 more)
...
Cohesion: 0.18
Nodes (16): AdminDashboard(), useCurrentUserId(), CorporateDashboardProps, EzMartDashboard(), SalesChart(), SalesDataPoint, useDashboardStats(), useSalesChart() (+8 more)

### Community 13 - "utils.ts"
Cohesion: 0.15
Nodes (18): QuickCheckoutModal, ProductoDetalleClientProps, QuickCheckoutModal, Product, ProductCard(), ProductCardProps, ProductImageCarousel(), ProductImageCarouselProps (+10 more)

### Community 14 - "checkout-form.tsx"
Cohesion: 0.12
Nodes (14): CheckoutAddress(), CheckoutAddressProps, CheckoutCustomer(), CheckoutCustomerProps, CheckoutFormProps, FormContent(), libraries, CheckoutShipping() (+6 more)
...
Cohesion: 0.25
Nodes (6): ProductoDetalleClient(), OrderItemsCard(), QuickCheckoutModal(), QuickSummary(), QuickSummaryProps, formatCurrency()
...
Cohesion: 0.22
Nodes (10): AdminPedido, AdminPedidoItem, Cliente, Cupon, Incidencia, Pedido, PedidoItem, PedidoPago (+2 more)
...
Cohesion: 0.05
Nodes (53): NotFound(), Home(), HomePageProps, metadata, NewsletterSection, revalidate, buildDescription(), buildProductUrl() (+45 more)

### Community 35 - "pedidos/page.tsx"
Cohesion: 0.13
Nodes (22): PedidosPageContent(), DialogDescription, CreateOrderModal(), CreateOrderModalProps, SelectedItem, OrdersBulkActions(), OrdersFilterBar(), OrdersTable() (+14 more)
...
Cohesion: 0.15
Nodes (7): CheckoutPage(), Skeleton(), DashboardStatsSkeleton(), OrderRowSkeleton(), TableRowSkeletonProps, useCartStore, CheckoutForm()
...
### Community 125 - "cn"
Cohesion: 0.16
Nodes (13): CardAction(), ScrollArea(), ScrollBar(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton(), SelectSeparator(), SheetFooter() (+5 more)
...
- **Why does `cn()` connect `cn` to `button.tsx`, `pedidos/[id]/page.tsx`, `pedidos/page.tsx`, `label.tsx`, `ProductosClient.tsx`, `utils.ts`, `checkout-form.tsx`, `skeleton.tsx`, `formatCurrency`, `checkout-payment.tsx`?**
...
- **Should `button.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.08697478991596638 - nodes in this community are weakly interconnected._
