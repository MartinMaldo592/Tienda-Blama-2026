...
function ProductosPageContent() {
    ...
    const [draftCount, setDraftCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [draftCategory, setDraftCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [draftSort, setDraftSort] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('name-asc');
    const [draftMinPrice, setDraftMinPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [draftMaxPrice, setDraftMaxPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [draftOnlyInStock, setDraftOnlyInStock] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [showAllCategoriesMobile, setShowAllCategoriesMobile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const visibleCategorias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductosPageContent.useMemo[visibleCategorias]": ()=>{
            ...
            const selected = categorias.find({
                "ProductosPageContent.useMemo[visibleCategorias]": (c)=>c.id.toString() === selectedCategory
            }["ProductosPageContent.useMemo[visibleCategorias]"]) || null;
            if (!selected) return base;
            if (base.some({
                "ProductosPageContent.useMemo[visibleCategorias]": (c)=>c.id === selected.id
            }["ProductosPageContent.useMemo[visibleCategorias]"])) return base;
            return [
                ...base,
                selected
            ];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductosPageContent.useEffect": ()=>{
            ...
            const handle = setTimeout({
                "ProductosPageContent.useEffect.handle": async ()=>{
                    const nextCount = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$products$2f$services$2f$products$2e$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["countProducts"])({
                        cat: draftCategory,
                        q: searchQuery,
                        min: draftMinPrice,
                        max: draftMaxPrice,
    ...
    const appliedBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductosPageContent.useMemo[appliedBadges]": ()=>{
            const badges = [];
            if (draftCategory !== 'all') {
                const catName = categorias.find({
                    "ProductosPageContent.useMemo[appliedBadges]": (c)=>c.id.toString() === draftCategory
                }["ProductosPageContent.useMemo[appliedBadges]"])?.nombre || 'Categoría';
                badges.push({
                    key: 'cat',
                    label: catName,
                    onClear: {
                        "ProductosPageContent.useMemo[appliedBadges]": ()=>setDraftCategory('all')
                    }["ProductosPageContent.useMemo[appliedBadges]"]
                });
            }
            if (draftMinPrice) {
                badges.push({
                    ...
                    onClear: {
                        "ProductosPageContent.useMemo[appliedBadges]": ()=>setDraftMinPrice('')
                    }["ProductosPageContent.useMemo[appliedBadges]"]
                });
            }
            if (draftMaxPrice) {
                badges.push({
                    ...
                    onClear: {
                        "ProductosPageContent.useMemo[appliedBadges]": ()=>setDraftMaxPrice('')
                    }["ProductosPageContent.useMemo[appliedBadges]"]
                });
            }
            if (draftOnlyInStock) {
                badges.push({
                    ...
                    label: 'Solo en stock',
                    onClear: {
                        "ProductosPageContent.useMemo[appliedBadges]": ()=>setDraftOnlyInStock(false)
                    }["ProductosPageContent.useMemo[appliedBadges]"]
                });
            }
            return badges;
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetContent"], {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                appliedBadges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "pt-4",
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProductosPageContent, "hjssH1mLdTUCPcUUXGxfhlZbEWE=", false, function() {
    return [
...
//# sourceMappingURL=_05954955._.js.map